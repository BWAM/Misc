...
####### Define input/output directories  #########
  ...
  input_dir <- "C:/Rscripts/RIBS.Data/data/2017_Routine_test/"
  ouput_dir <- "C:/Rscripts/RIBS.Data/output/testing_bind/"
...
write.table(RIBSdata, file="RIBSdata.csv",sep=",", row.names = FALSE)
